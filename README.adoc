= axon-examples image:https://github.com/daggerok/axon-examples/actions/workflows/ci.yml/badge.svg["Build Status", link="https://github.com/daggerok/axon-examples/actions/workflows/ci.yml"]
